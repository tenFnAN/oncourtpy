...
today_schedule = tns_wta.get_schedule_today()
player_df = tns_wta.get_player_data(players_id= today_schedule[['id_P1', 'id_P2']].melt()['value'].unique() )

tns_atp = onc.OncourtDb( 'atp', 'double') 
today_single_pre_atp = tns_atp.get_schedule_today()
```
